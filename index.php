...
if(( $_SESSION['acceso'] <>true)){
    ...
    echo 'Usted no tiene acceso a este pagina';
}
...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/Mas.png" />
    <!-- Bootstrap icons-->
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet" /> -->
    <!-- Core theme CSS (includes Bootstrap)-->
    <link href="assets/css/styles.css" rel="stylesheet" />
    <link href="assets/css/estilos.css" rel="stylesheet" />
    <link rel="stylesheet" href="assets/css/iconowhatapp.css">
</head>

<body>
    <!-- iconos flotantes -->
    <a href="https://bit.ly/37xE092whatsapp_davd_vilcabana" class="btn-wsp" target="_blank">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">TIENDA MASS</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <?php } ?>
                        <a class="nav-link" href="infor.php">Mas Informacion</a>
                        <a class="nav-link" href="login.php" class="cerrar">Cerrar Session</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Productos de calidad.</p>
                <p class="lead fw-normal text-white-50 mb-0">Creado por los malditos de Santa Maria</p>
            </div>
        </div>
    </header>
